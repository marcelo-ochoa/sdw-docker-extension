...
```bash
$ docker extension install mochoa/sdw-docker-extension:23.3.0
Extensions can install binaries, invoke commands and access files on your machine. 
Are you sure you want to continue? [y/N] y
Installing new extension "mochoa/sdw-docker-extension:23.3.0"
...
```bash
$ docker extension uninstall mochoa/sdw-docker-extension:23.3.0
